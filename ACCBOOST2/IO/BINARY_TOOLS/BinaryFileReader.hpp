#ifndef ACCBOOST2_IO_BINARY_TOOLS_BINARYFILERADER_HPP_
#define ACCBOOST2_IO_BINARY_TOOLS_BINARYFILERADER_HPP_
...
namespace ACCBOOST2::IO::BINARY_TOOLS
{
  ...
  namespace _impl_BinaryFileReader
  {
  ...
  static inline std::unique_ptr<BinaryReader> make_binary_fd_reader(int file_descriptor)
  {
    return std::make_unique<_impl_BinaryFileReader::BinaryFDReader>(file_descriptor);
  }

  static inline std::unique_ptr<BinaryReader> make_binary_file_reader(const std::string& file_path)
  {
    return std::make_unique<_impl_BinaryFileReader::BinaryFileReader>(file_path);
  }

  static inline std::unique_ptr<BinaryReader> make_binary_stdin_reader()
  {
